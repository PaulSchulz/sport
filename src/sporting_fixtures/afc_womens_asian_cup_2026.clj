(ns sporting-fixtures.afc-womens-asian-cup-2026
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(def event-name   "afc-womens-asian-cup-2026")
(def event-data   "data/")
...
(defn reload []
  (do
    (println (str "Reloading " event-name)
    (use 'sporting-fixtures.afc-womens-asian-cup-2026 :reload-all)))
  ...
  (println
   (str/join
    "\n" [
          ...
          "lein run -m sporting-fixtures.afc-womens-asian-cup-2026"
          ""
          ";; Printing"
          "lein run -m sporting-fixtures.afc-womens-asian-cup-2026 | enscript -B -f Courier9 | lp"
          ]
    )))
